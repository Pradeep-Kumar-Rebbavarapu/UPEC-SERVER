                    ...
                    <>
                      {(EachProject?.data?.workflow === null) && (
                        <button className=" text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-md m-5 text-center flex justify-center items-center" onClick={() => {
                          if(EachProject?.data?.prd === null){
                            toast.error('PRD not generated by client')
                            return
                          }
                          setIsOpen(true)
                      ...
                      {( (EachProject?.data?.project_management == null || EachProject?.data?.project_management.length == 0 || EachProject?.data?.project_management == "")) && (
                        <button onClick={() => {
                          if(EachProject?.data?.prd == null){
                            toast.error('PRD not generated by client')
                            return
